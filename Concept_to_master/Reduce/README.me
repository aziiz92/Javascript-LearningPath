# Reduce
The reduce() method applies an "accumulator" function that processes each value in a list (from left to right) in order to reduce it to a single value.[(MDN Definition)](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce)
...
![Exemple imagé](http://url/to/img.png)
